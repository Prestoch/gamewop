...
sub build_email_html {
  ...
  $html.='<div style="font:bold 13px Arial,Helvetica,sans-serif;margin:8px 0 4px 0;">Team A</div>';
  $html.='<table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;"><tr>'.$r1a.'</tr><tr>'.$r2a.'</tr></table>';
  $html.='<div style="font:bold 13px Arial,Helvetica,sans-serif;margin:16px 0 4px 0;">Team B</div>';
